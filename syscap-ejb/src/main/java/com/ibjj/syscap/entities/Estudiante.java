...
@NamedQueries({
    ...
    @NamedQuery(name = "Estudiante.findByCedulaPas", query = "SELECT e FROM Estudiante e WHERE e.cedulaPas = :cedulaPas"),
...
public class Estudiante implements Serializable {
    ...
    public Estudiante(Integer idEstudiante, String nombres, String apellidos, String cedulaPas, String sexo, Date fechaNacimiento) {
        this.idEstudiante = idEstudiante;
    ...
    public String toString() {
        return "com.ibjj.syscap.entities.Estudiante[ idEstudiante=" + idEstudiante + " ]";
    }
